...
CarriersResponse carriersResponseFromJson(String str) =>
    CarriersResponse.fromJson(json.decode(str));

String carriersResponseToJson(CarriersResponse data) =>
    json.encode(data.toJson());

class CarriersResponse {
  CarriersResponse({this.data, this.success, this.status});

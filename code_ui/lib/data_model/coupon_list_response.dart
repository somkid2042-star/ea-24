...
class CouponData {
  ...
  factory CouponData.fromJson(Map<String, dynamic> json) => CouponData(
    ...
    couponProductDetails: json["coupon_product_details"] == null
        ? []
        : List<CouponProductDetail>.from(
            json["coupon_product_details"]!.map(
              (x) => CouponProductDetail.fromJson(x),
            ),
          ),
...
class CouponDiscountDetails {
  ...
  CouponDiscountDetails({this.minBuy, this.maxDiscount});
...
class CouponProductDetail {
  ...
  CouponProductDetail({this.productId});

  factory CouponProductDetail.fromJson(Map<String, dynamic> json) =>
      CouponProductDetail(productId: json["product_id"]);

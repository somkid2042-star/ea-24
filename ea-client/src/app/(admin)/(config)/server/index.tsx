  ...
  return (
    <main className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-lg font-semibold text-default-900">Server & Database</h4>
          <p className="mt-1 text-sm text-default-500">
            Manage EA Trading Server — start, stop, restart, monitor status & database
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <div className="card">
          <div className="p-4">
            ...
            <p className="text-lg font-bold tabular-nums text-default-900">
              {dbStats ? dbStats.total_ticks.toLocaleString() : '—'}
            </p>
            <p className="mt-0.5 text-[10px] text-default-400">
              Last: {dbStats?.latest_tick_time || '—'}
            </p>
          </div>
        </div>
        ...
        <div className="card">
          <div className="p-4">
            ...
            <p className="text-lg font-bold tabular-nums text-default-900">
              {dbStats ? dbStats.total_trades.toLocaleString() : '—'}
            </p>
            <p className="mt-0.5 text-[10px] text-default-400">
              Last: {dbStats?.latest_trade_time || '—'}
            </p>
          </div>
        </div>
        ...
        <div className="card">
          <div className="p-4">
            ...
            <p className="text-lg font-bold tabular-nums text-default-900">
              {dbStats ? formatBytes(dbStats.db_size_bytes) : '—'}
            </p>
          </div>
        </div>
        ...
        <div className="card">
          <div className="p-4">
            ...
            <p className="truncate text-sm font-medium text-default-900" title={dbStats?.db_path}>
              {dbStats?.db_path || '—'}
            </p>
          </div>
        </div>

      ...
      <div className="rounded-lg border border-default-200 bg-white p-5 dark:bg-default-50">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            <input type="password" defaultValue="ea24-api-key-xxxx" className="w-full rounded-md border border-default-200 px-3 py-2.5 text-sm focus:border-primary focus:outline-none" />
          </div>
          <div>
      ...
      <div className="rounded-lg border border-default-200 bg-white p-5 dark:bg-default-50">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            <input type="text" placeholder="Enter your license key" className="w-full rounded-md border border-default-200 px-3 py-2.5 text-sm focus:border-primary focus:outline-none" />
          </div>

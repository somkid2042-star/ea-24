        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <input type="text" defaultValue="./data/ea24.db" className="w-full rounded-md border border-default-200 px-3 py-2.5 text-sm bg-transparent focus:border-primary focus:outline-none dark:border-default-200 dark:text-white" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="number" defaultValue="10" className="w-full rounded-md border border-default-200 px-3 py-2.5 text-sm bg-transparent focus:border-primary focus:outline-none dark:border-default-200 dark:text-white" />
            </div>
            <div>
              <label className="mb-1.5 block text-sm font-medium text-default-700">Backup Interval (hours)</label>
              <input type="number" defaultValue="24" className="w-full rounded-md border border-default-200 px-3 py-2.5 text-sm bg-transparent focus:border-primary focus:outline-none dark:border-default-200 dark:text-white" />
            </div>
          </div>
